                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <?php
                        ...
                        if(isset($_GET['submit'])){
                            ...
                            mysqli_close($conn);
                            echo "แก้ไขข้อมูลอาจารย์ $std_fname $std_lname เรียบร้อยแล้ว<br>";
                            echo '<a href="lecturer_list.php">แสดงรายชื่อนักศึกษาทั้งหมด</a>';
                        }else{
                    ?>
                    <form class="form-horizontal" role="form" name="lecturer_edit" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-lg-10">
                                ...
                                <?php
                                    include 'connectdb.php';
                                    $sql2 = "select * from lecturer where std_id='$std_id'";
